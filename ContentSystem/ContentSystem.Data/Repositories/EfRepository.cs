...
namespace ContentSystem.Data.Repositories
{
    ...
    public class EfRepository<T> : IRepository<T> where T : class, IAggregateRoot
    {
        ...
        protected virtual IDbSet<T> Entities
        {
            get
            {
               ...
               // return new ContentDbContext("ContentDB").Set<T>();
            }
        }
        ...
        public IQueryable<T> Table
        {
            get
            {
                this._dbContext = new ContentDbContext("ContentDB"); this._entities = null;
        ...
        { 
            this._dbContext = new ContentDbContext("ContentDB");
